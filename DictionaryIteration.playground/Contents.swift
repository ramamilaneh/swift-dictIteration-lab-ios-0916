...
print("\(bandName)'s top selling album was \(band[bandName])")
 ...
 */
// by creating a dictionary. The keys are the grades which are Int variables and the values are the results will be String variables
// results: [Int:String]
